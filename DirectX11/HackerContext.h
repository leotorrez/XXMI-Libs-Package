...
private:
	...
	void RecordShaderResourceUsage(std::map<UINT64, ShaderInfoData> &ShaderInfo, UINT64 currentShader, ID3D11DeviceChild *shaderHandle);
	...
	void RecordShaderSlotProfiling();
